...
gtfs_shapes_1 = pd.read_csv(r"C:\Users\SafeTravelPH\Documents\Parasol Files\shapes_route9.txt")
...
gtfs_shapes_2 = pd.read_csv(r"C:\Users\SafeTravelPH\Documents\Parasol Files\shapes_route17.txt")
...
shapes_gdf_1.plot(ax=ax, color='blue', linewidth=1, label="Route 9")
shapes_gdf_2.plot(ax=ax, color='green', linewidth=1, label="Route 17")
